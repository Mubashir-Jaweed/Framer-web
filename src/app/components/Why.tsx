    ...
    return (
        <div className='w-full  p-32 text-white flex flex-col gap-12'>
            ...
            <div className='flex justify-start items-center gap-5 '>
                ...
                <div>
                    <span className='main-font text-[38px] font-normal leading-[44px] [word-spacing:-3px]'>Our Specialities</span>
                </div>
            </div>
            {/* row 2 */}
            ...
            <div className="grid grid-cols-12 gap-3 w-full">
                {/* 1 */}
                <div className="col-span-8 why-bg1 rounded-[30px] p-8 h-[450px] flex justify-center items-end">
                    <div className='w-full flex flex-col gap-5 justify-start items-start'>
                        <div className='flex flex-col'>
                            <span className='main-font text-[100px] leading-[95px]'>150%</span>
                            <span className='uppercase main-font text-[20px]'>average traffic increase</span>
                        </div>
                ...
                {/* 2 */}
                <div className="col-span-4 bg-[#1f1d1d] rounded-[30px] p-8 h-[450px] flex flex-col justify-between items-start">
                    <div className='flex flex-col'>
                        <span className='main-font text-[100px] leading-[95px]'>$74M</span>
                        <span className='uppercase main-font text-[20px]'>Revenue Generated</span>
                    </div>
                    <p className='text-[16px] font-normal text-[#fff] break-words whitespace-pre-line'>
                        We help generated $74M revenue for our clients around the globe                    </p>
                </div>
                {/* 3 */}
                <div className="col-span-6 why-bg rounded-[30px] p-8 h-[450px] flex justify-center items-center">
                    <div className='glass-bg border-[0.1px] border-zinc-200/40 rounded-full h-[350px] w-[350px]'>

                    </div>
                </div>
                {/* 4 */}
                <div className="col-span-6 bg-[#f58327] text-black rounded-[30px] p-8 h-[450px] flex flex-col justify-between items-start">
                    <div className='w-full flex flex-col-reverse items-end '>
                        <span className='main-font text-[100px] leading-[95px]'>80%</span>
                        <span className='uppercase main-font text-[20px]'>Enhanced Brand Visibility</span>
                    </div>
