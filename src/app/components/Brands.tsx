...
const Brands = () => {
    return (
        <div className='bg-[#0a0a0a] w-full px-5  sm:px-10 py-16 lg:p-32 flex flex-col justify-center items-center gap-2'>
            ...
            <span className='main-font text-[28px] md:text-[30px] lg:text-[38px] font-normal leading-[44px] [word-spacing:-3px] text-white'>Brands that trust us </span>
