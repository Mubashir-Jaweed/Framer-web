...
const Button = ({ btnText, isGap = true }: { btnText: string, isGap?: boolean }) => {
  return (
    ...
    >
      <span className="pointer-events-none main-font text-[13px] leading-[19.5px] uppercase text-black bg-[#f58327] rounded-tl-full rounded-bl-full py-3.5 px-7 flex items-center">
        {btnText}
      </span>
