...
const AboutMarqueReverse = ({customClass, text= 'I am Batman'}:{customClass?:string,text?:string}) => {
  ...
  return (
    <div className={`flex w-full overflow-hidden text-zinc-300 ${customClass}`}>
      <div className="flex gap-2 animate-marqueeReverse whitespace-nowrap main-font text-center  text-[95px] font-medium text-white ">
        {marqueeContent}
        {marqueeContent} 
      </div>
    </div>
...
export default AboutMarqueReverse;