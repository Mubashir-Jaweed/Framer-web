...
const Hero = () => {
    ...
    return (
        <div className='w-full  px-32 pt-40 text-white flex flex-col justify-center items-center gap-28'>
            <div>
                <span className='main-font text-[50px] font-normal leading-[55px] [word-spacing:-3px] [letter-spacing:-2px] text-center flex justify-center items-center'>Let's Work Together</span>
            </div>
            <div className='w-[85%] h-min rounded-[30px] bg-[#33333346] p-5 grid gap-2.5 grid-cols-3 '>
                {/* 1.1 */}
                <div className=' h-[220px] flex flex-col justify-start items-start gap-5 rounded-[20px] bg-[#45454546]  px-5 py-7'>
                    <span className='main-font text-white text-[16px] font-thin'>
                        Hotline:
                    </span>
                    <span className='main-font text-white uppercase text-[20px] font-normal cursor-pointer  hover:underline hover:text-[#f58327]'>
                        (555) 123-4567
                    </span>
                </div>
                {/* 1.2 */}
                ...
                {/* 2.1 */}
                <div className='h-[220px] flex flex-col justify-start items-start gap-5 rounded-[20px] bg-[#45454546]  px-5 py-7 col-span-2'>
                    <span className='main-font text-white text-[16px] font-thin'>
                        Opening Hours:
                    </span>
                    <span className='main-font text-white uppercase text-[20px] font-normal cursor-pointer '>
                ...
                {/* 2.2 */}
                <div className='rounded-[20px] bg-[#45454546] px-5 py-7 h-[220px] flex flex-col justify-start items-start gap-5'>
